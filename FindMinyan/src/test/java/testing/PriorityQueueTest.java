...
public class PriorityQueueTest {
    // these are, for the most part, tests that I have borrowed from Data Structures, modified for the new API

    private final PriorityQueue<TestClass> heap;
    private final TestClass[] stuff;
